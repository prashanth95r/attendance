...
{
$roll=$_GET['val'];
$query="SELECT * FROM faculty_login WHERE user_name=$roll";
$res=mysql_query($query);

if($row=mysql_fetch_array($res))
{

$que=mysql_query("UPDATE faculty_login SET user_level='3' WHERE user_name=$roll") or die(mysql_error());
if($que)
{
	echo "<script type=\"text/javascript\">";
	echo "alert(\"Sucessfully created\")";
	echo "</script>";
	echo "<h2><center>Successfully created</center></h2>"; 
	header('refresh:3;url=home.php');
}

}else echo "Not succesfull try again";
