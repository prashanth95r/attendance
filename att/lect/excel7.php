...
<?php
	...
	$query="SELECT * FROM faculty_login WHERE user_level='2'";
	$result=mysql_query($query);
	echo "<table class=\"inner_table1\">";
	echo "<tr><td><b>id</b></td><td><b>name</b></td><td><b>Last Name</b></td><td><b>Password</b></td></td>";
	if($result)
	{
	while($row=mysql_fetch_array($result))
	{
				...
				echo "<td>".ABDecryption(substr($row['user_name'],-9),$row['password'])."</td></tr>";
			
			
			
	}
	}
	else echo"<tr>no results found</tr>";
	echo "</table>";
?>