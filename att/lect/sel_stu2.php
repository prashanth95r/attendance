...
if(!isset($_GET['to_type'])||!isset($_GET['branch'])||!isset($_GET['section'])||!isset($_GET['year']))
{
	exit();
}
?>
	...
	if($result)
	{
		if(mysql_num_rows($result))
		{
			...
			while($row=mysql_fetch_array($result))
			{
				...
				$name=getNameStu($rollnumber);
				echo "<tr>";
				echo "<td>".$rollnumber."</td>";
				echo "<td>".$name."</td>";
				echo "<td>"."<a href=\"gen_alrt.php?to_type=$to_type&roll_number=$rollnumber\">Generate Alert</a> "."</td>";
				echo "</tr>";
			}
		}
		else
		{
			echo "No students found in the current section";
		}
	}
	else
	{
