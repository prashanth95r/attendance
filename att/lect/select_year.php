...
$fac_branch=getDeptCode($username);
if($fac_branch=="S&H")
{
	echo "Select a Branch"."<br/>";
	echo "<a href=\"sel_stu_prom.php?dept=CSE&year=1&sem=1\" ><h3><center>CSE</center></h3></a>"."<br/>";
	echo "<a href=\"sel_stu_prom.php?dept=ECE&year=1&sem=1\" ><h3><center>ECE</center></h3></a>"."<br/>";
	echo "<a href=\"sel_stu_prom.php?dept=IT&year=1&sem=1\" ><h3><center>IT</center></h3></a>"."<br/>";
	echo "<a href=\"sel_stu_prom.php?dept=EEE&year=1&sem=1\" ><h3><center>EEE</center></h3></a>"."<br/>";
	echo "<a href=\"sel_stu_prom.php?dept=MECH&year=1&sem=1\" ><h3><center>MECH</center></h3></a>"."<br/>";
	echo "<a href=\"sel_stu_prom.php?dept=AUTO&year=1&sem=1\" ><h3><center>AUTO</center></h3></a>"."<br/>";
	echo "<a href=\"sel_stu_prom.php?dept=CIV&year=1&sem=1\" ><h3><center>CIV</center></h3></a>"."<br/>";
}
elseif($fac_branch=="MCA")
{
	$year1_sem=getSem($fac_branch,1);
	$year2_sem=getSem($fac_branch,2);
	$year3_sem=getSem($fac_branch,3);
	echo "<a href=\"sel_stu_prom.php?dept=MCA&year=1&sem=$year1_sem\" ><h3><center>Promote 1st Year students</center></h3></a>"."<br/>";
	echo "<a href=\"sel_stu_prom.php?dept=MCA&year=2&sem=$year2_sem\" ><h3><center>Promote 2nd Year students</center>r</h3></a>"."<br/>";
	if(!($year3_sem==2))
	echo "<a href=\"sel_stu_prom.php?dept=MCA&year=3&sem=$year3_sem\" ><h3><center>Promote 3rd Year students</center></h3></a>"."<br/>";
}
elseif($fac_branch=="MBA")
{
	$year1_sem=getSem($fac_branch,1);
	$year2_sem=getSem($fac_branch,2);
	echo "<a href=\"sel_stu_prom.php?dept=$fac_branch&year=1&sem=$year1_sem\" ><h3><center>Promote 1st Year students</center></h3></a>"."<br/>";
	if(!($year2_sem==2))
	echo "<a href=\"sel_stu_prom.php?dept=$fac_branch&year=2&sem=$year2_sem\" ><h3><center>Promote 2nd Year students</center></h3></a>"."<br/>";
}
elseif($fac_branch=="CSE")
{
	$year2_sem=getSem($fac_branch,2);
	$year3_sem=getSem($fac_branch,3);
	$year4_sem=getSem($fac_branch,4);
	echo "<a href=\"sel_stu_prom.php?dept=$fac_branch&year=2&sem=$year2_sem\" ><h3><center>Promote 2nd Year students</center></h3></a>"."<br/>";
	echo "<a href=\"sel_stu_prom.php?dept=$fac_branch&year=3&sem=$year3_sem\" ><h3><center>Promote 3rd Year students</center></h3></a>"."<br/>";
	if(!($year4_sem==2))
	echo "<a href=\"sel_stu_prom.php?dept=$fac_branch&year=4&sem=$year4_sem\" ><h3><center>Promote 4th Year students</center></h3></a>"."<br/>";
	
	//mtech students
	$year1_sem=getSem("MCSE",1);
	$year2_sem=getSem("MCSE",2);
	echo "<a href=\"sel_stu_prom.php?dept=MCSE&year=1&sem=$year1_sem\" ><h3><center>Promote M.Tech 1st Year students</center></h3></a>"."<br/>";
	if(!($year2_sem==2))
	echo "<a href=\"sel_stu_prom.php?dept=MCSE&year=2&sem=$year2_sem\" ><h3><center>Promote M.Tech 2nd Year students</center></h3></a>"."<br/>";
}
else
{
	$year2_sem=getSem($fac_branch,2);
