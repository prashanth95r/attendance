...
function checkAll(formname, source)
{
	...
	if($flag==0)
	{
		...
		if($result)
		{
			...
			{
				echo "<center><form action=\"test30.php\" id=\"form1\" name=\"myform\">";
				...
				if($x==0)
				{
						echo "<h1><center><b>No relevant data found";
						exit();
				}
				echo "<br/>";
			...
			{
				echo "<h1><center><b>Currently no students exists in this section.contact admin for more details";
			}
		}
		else
		{
			echo "erreor in querying";
		}
	}
	elseif($flag==1)
	{	
	...
	elseif(isAlreadyEntered($sp,$year,$section))
	{
