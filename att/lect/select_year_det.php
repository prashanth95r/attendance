...
<?php
echo "<h2><center>Select year</center></h2>";
...
if($fac_branch=="MCA")
{
	...
	echo "<a href=\"sel_stu_det.php?dept=MCA&year=1&sem=$year1_sem\" ><h3><center>1st Year</center></h3></a>"."<br/>";
	echo "<a href=\"sel_stu_det.php?dept=MCA&year=2&sem=$year2_sem\" > <h3><center>2nd Year</center></h3></a>"."<br/>";
	echo "<a href=\"sel_stu_det.php?dept=MCA&year=3&sem=$year3_sem\" > <h3><center>3rd Year</center></h3></a>"."<br/>";
}
elseif($fac_branch=="MBA")
{
	$year1_sem=getSem($fac_branch,1);
	$year2_sem=getSem($fac_branch,2);
	echo "<a href=\"sel_stu_det.php?dept=$fac_branch&year=1&sem=$year1_sem\" > <h3><center>1st Year</center></h3></a>"."<br/>";
	echo "<a href=\"sel_stu_det.php?dept=$fac_branch&year=2&sem=$year2_sem\" ><h3><center>2nd Year</center></h3></a>"."<br/>";
}
elseif($fac_branch=="CSE")
{
	...
	echo "<a href=\"sel_stu_det.php?dept=$fac_branch&year=2&sem=$year2_sem\" > <h3><center>2nd Year</center></h3></a>"."<br/>";
	echo "<a href=\"sel_stu_det.php?dept=$fac_branch&year=3&sem=$year3_sem\" ><h3><center>3rd Year</center></h3></a>"."<br/>";
	echo "<a href=\"sel_stu_det.php?dept=$fac_branch&year=4&sem=$year4_sem\" ><h3><center>4th Year</center></h3></a>"."<br/>";
	
	//mtech students
	$year1_sem=getSem("MCSE",1);
	$year2_sem=getSem("MCSE",2);
	echo "<a href=\"sel_stu_det.php?dept=MCSE&year=1&sem=$year1_sem\" ><h3><center>M.Tech 1st Year</center></h3></a>"."<br/>";
	echo "<a href=\"sel_stu_det.php?dept=MCSE&year=2&sem=$year2_sem\" ><h3><center>M.Tech 2nd Year</center></h3></a>"."<br/>";
}
else
{
	$year2_sem=getSem($fac_branch,2);
