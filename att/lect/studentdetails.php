...
header("location:studetails.php?year=$year&section=$section");
}
...
<table><tr><td>
YEAR</td><td><select name="year" id="year" >
<option value="1">1</option>
<option value="2">2</option>
<option value="3">3</option>
<option value="4">4</option>
</select></td></tr>
<tr><td>SECTION</td><td><input type="text" name="branch" placeholder="CSE3" /></td></tr>
</table>
