...
$pre=serialize($p);
$abs=serialize($a);
header("location:confirm_attele.php?year=$year&subject=$subject_id&sec=$section&sp=$sp&np=$np&no_stu=$no_stu&no_pre=$pre_count&pre=$pre&no_abs=$abs_count&abs=$abs");
?>