...
if(!isset($_GET['thisfac_id'])||!isset($_GET['per_id']))
{
	exit();
}
?>
...
<?php
$this_faculty=$_GET['thisfac_id'];
$period=$_GET['per_id'];
echo "<h2><center>Please select the department of the faculty to whom you want to assign the class</center></h2>";
$query="SELECT * FROM branch_det";
	...
	if($result)
	{
		if(mysql_num_rows($result)>0)
		{
			...
			while($row=mysql_fetch_array($result))
			{
				...
				echo "<td>"."<a href=\"sel_fac_assign.php?branch=$branch&thisfac_id=$this_faculty&per_id=$period\">Select</a>"."</td>";
				echo "</tr>";
			}
		}
		else
