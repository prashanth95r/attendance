...
$dep=$_SESSION['dept'];
$date=date('Y-m-d');
$query="SELECT * FROM comp_class_details WHERE date='$date' AND section='$sec' AND year='$year' ORDER BY period";
$res=mysql_query($query) or die(mysql_error()); 
echo"<table class=\"inner_table1\">
<tr><td><b>period</b></td><td><b>year</b></td>
<td><b>section</b></td>
<td><b>subject</b></td>
<td><b>subject taught</b></td></tr>";
...
{$sub=$row['subject'];
echo"<tr><td>$row[period]</td><td>$row[year]</td><td>$row[section]</td><td>".getFullPeriod($sub)."</td><td>$row[sub_taught]</td></tr>";
}
}
echo"</table>";
}
else "<tr>no notes found</tr>";
}
