...
if(!isset($_GET['to_type'])||!isset($_GET['branch']))
{
	exit();
}
?>
	...
	if($result)
	{
		if(mysql_num_rows($result)>0)
		{
			...
			while($row=mysql_fetch_array($result))
			{
				...
				echo "<td>".$row['faculty_name']."&nbsp;&nbsp;".$row['faculty_last_name']."</td>";
				echo "<td>"."<a href=\"gen_alrt.php?to_type=$to_type&fac_id=$fac_id\">Genrate Alert</a>"."</td>";
				echo "</tr>";
			}
			echo "</table>";
		}
