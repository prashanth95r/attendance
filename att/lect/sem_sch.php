...
$fac_id=$_GET['id'];
$query="SELECT * FROM faculty_schedule_yearsecsub WHERE user_name='$fac_id' LIMIT 1";
$result=mysql_query($query);
if($result)
{ echo"<table class=\"inner_table1\" border=\"1\" width=\"400\">";
echo"<tr><td colspan=\"3\"><b>period1(year,section,subject)</b></td><td colspan=\"3\"><b>period2(year,section,subject)</b></td><td colspan=\"3\"><b>period3(year,section,subject)</b></td><td colspan=\"3\"><b>period4(year,section,subject)</b></td><td colspan=\"3\"><b>period5(year,section,subject)</b></td><td colspan=\"3\"><b>period6(year,section,subject)</b></td><td colspan=\"3\"><b>period7(year,section,subject)</b></td></tr>";
	if(mysql_num_rows($result)>0)
	{
		...
		{if(($i-1)%7==0)
			...
			if($det[0]!="FREE")
			{
				echo "<td>".$det[0]."</td><td>";
				echo $det[1]."</td><td>";
				echo getFullPeriod($det[2])."</td>";
			}
			else
			{
				echo "<td>".$det[0]."</td><td>-</td><td>-</td>";
			}
			if($i%7==0)
			{
				echo "</tr>";
