...
if(isset($_GET['id']))
{
	if($_GET['id']==0)
	{
		echo "Promoted Students Succesfully.We are redirecting you.";
		header("refresh:5;url=msem.php");
	}
	elseif($_GET['id']==1)
	{
		echo "Promoting Students Failed.Try Later.We are redirecting you.";
		header("refresh:5;url=msem.php");
	}
}
else
{
	header("location:msem.php");
}
?>
