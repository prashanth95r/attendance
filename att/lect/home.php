...
$queryrec="SELECT * FROM faculty_login WHERE user_name='$username'";
...
{
	echo "Unkknown error encountered.Please wait while redirecting you.";
...
";
	...
	echo "<br><br>";
	echo "<center><a href=\"studentdetails.php\"><h3><center>View details Of a student</center></h3></a></center>";
	echo "<br><br>";
	echo "<center><a href=\"viewstuatt.php\"><h3><center>View attendence of student</center></h3></a></center>";
	echo "<br><br>";
	echo "<center><a href=\"alert_section.php\"><h3><center>Alerts ";if($count==0){echo " ";}
				elseif($count==1)
...
";*/
	...
	echo "<br><br>";
	echo "<center><a href=\"fac_det.php\"><h3><center>View branch wise schedule/assign class</center></h3></a></center>";
	echo "<br><br>";
...
";
	...
	echo "<center><a href=\"studentdetails.php\"><h3><center>View details of a student</center></h3></a></center>";
	echo "<br><br>";
	echo "<center><a href=\"viewstuatt.php\"><h3><center>View attendence of a student</center></h3></a></center>";
	echo "<br><br>";
	
	echo "<center><a href=\"fac_det.php\"><h3><center>View branch wise schedule/assign class</center></h3></a></center>";
	echo "<br><br>";
	echo "<center><a href=\"chk_free.php\"><h3><center>View free slots</center></h3></a></center>";
	echo "<br><br>";
	echo "<center><a href=\"alert_section.php\"><h3><center>Alerts ";if($count==0){echo " ";}
				elseif($count==1)
				{echo "<script>alert(\"You have an new alert\");</script>";
...
";*/
	...
	echo "<br><br>";
	echo "<center><a href=\"fac_det.php\"><h3><center>View time table branch wise/assign class</center></h3></a></center>";
	echo "<br><br>";
