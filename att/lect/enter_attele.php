<?php
	...
	require_once('../funcs/checkassign.php');
...
function checkAll(formname, source)
{
	...
	if($flag==0)
	{
		...
		if($result)
		{
			...
			{
				echo "<center><form action=\"test2.php\" id=\"form1\" name=\"myform\">";
			...
			{
				echo "<h1><center><b>Currently no students exists in this section.contact admin for more details</b></center></h1>";
			}
		}
		else
		{
