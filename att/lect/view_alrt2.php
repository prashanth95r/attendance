...
if($result)
{echo "<table class=\"inner_table\" width=\"500\">";

	if(mysql_num_rows($result)>0)
	{
		$row=mysql_fetch_assoc($result);
		echo "<tr><td>Subject</td><td>".$row['alert_subject']."</td></tr>";
		echo "<tr><td>Generated on</td><td>".$row['alert_time']."</td></tr>";
		echo "<tr><td>Generated By</td><td>".getName1($row['alert_by'])."</td></tr>";
