...
if($query)
{
	...
	echo "alert(\"Entered schedule sucessfully.\")";
	echo "</script>";
	echo "<h2><center><b>Successfuly Entered Schedule</b></center></h2>";
	//header("refresh:2;url=home.php");
}
else
{
	echo "<h2><center>Failed to enter schedule</center></h2>";
}
...
?>
<h2><center>Format to enter the schedule is Year, section, subject code</center></h2>
<h2><center>Example:2,cse3,cs301("," should also be specified)</center></h2>
<h1><font color="#0000CC"><center>Enter Schedule</center></font></h1>
...
<td>Monday</td>
<td>
<input type="text" class="input" name="mp1" id="mp1" /> </td>
<td>
<input type="text" class="input" name="mp2" id="mp2" /> </td>
<td>
<input type="text" class="input"  name="mp3" id="mp3" /></td> 
 <td>
<input type="text" class="input"  name="mp4" id="mp4" /> </td>
<td>
<input type="text" class="input" name="mp5" id="mp5" /></td> 
<td>
<input type="text" class="input" name="mp6" id="mp6" /></td> 
<td>
<input type="text" class="input"  name="mp7" id="mp7" />            
</td>
</tr>
<tr class="alt">
<td>Tuesday</td>
<td>
<input type="text" class="input" name="tp1" id="tp1"  /> </td>
<td>
<input type="text" class="input" name="tp2" id="tp2" /> </td>
<td>
<input type="text" class="input"  name="tp3" id="tp3" /></td> 
 <td>
<input type="text" class="input"  name="tp4" id="tp4" /> </td>
<td>
<input type="text" class="input" name="tp5" id="tp5" /></td> 
<td>
<input type="text" class="input" name="tp6" id="tp6" /></td> 
<td>
<input type="text" class="input"  name="tp7" id="tp7" />            
</td>
</tr>
<tr>
<td>Wednesday</td>
<td>
<input type="text" class="input" name="wp1" id="wp1" /> </td>
<td>
<input type="text" class="input" name="wp2" id="wp2" /> </td>
<td>
<input type="text" class="input"  name="wp3" id="wp3" /></td> 
 <td>
<input type="text" class="input"  name="wp4" id="wp4" /> </td>
<td>
<input type="text" class="input" name="wp5" id="wp5" /></td> 
<td>
<input type="text" class="input" name="wp6" id="wp6" /></td> 
<td>
<input type="text" class="input"  name="wp7" id="wp7" />            
</td>
</tr>
<tr class="alt">
<td>Thursday</td>
<td>
<input type="text" class="input" name="thp1" id="thp1" /> </td>
<td>
<input type="text" class="input" name="thp2" id="thp2" /> </td>
<td>
<input type="text" class="input"  name="thp3" id="thp3" /></td> 
 <td>
<input type="text" class="input"  name="thp4" id="thp4" /> </td>
<td>
<input type="text" class="input" name="thp5" id="thp5" /></td> 
<td>
<input type="text" class="input" name="thp6" id="thp6" /></td> 
<td>
<input type="text" class="input"  name="thp7" id="thp7" /></td>
</tr>
<tr>
<td>Friday</td>
<td>
<input type="text" class="input" name="fp1" id="fp1" /> </td>
<td>
<input type="text" class="input" name="fp2" id="fp2" /> </td>
<td>
<input type="text" class="input"  name="fp3" id="fp3" /></td> 
 <td>
<input type="text" class="input"  name="fp4" id="fp4" /> </td>
<td>
<input type="text" class="input" name="fp5" id="fp5" /></td> 
<td>
<input type="text" class="input" name="fp6" id="fp6" /></td> 
<td>
<input type="text" class="input"  name="fp7" id="fp7" />            
</td>
</tr>
<tr class="alt">
<td>Saturday</td>
<td>
<input type="text" class="input" name="sp1" id="sp1" /> </td>
<td>
<input type="text" class="input" name="sp2" id="sp2" /> </td>
<td>
<input type="text" class="input"  name="sp3" id="sp3" /></td> 
 <td>
<input type="text" class="input"  name="sp4" id="sp4" /> </td>
<td>
<input type="text" class="input" name="sp5" id="sp5" /></td> 
<td>
<input type="text" class="input" name="sp6" id="sp6" /></td> 
<td>
<input type="text" class="input"  name="sp7" id="sp7" />            
</td>
</tr>
</table><br>
<center><button class="css_button" name="submit">submit</button>
</form></center>
