...
if($id==1)
{
echo "<center><font size=\"4\">Succesfully Entered.Redirecting you.</font>";
			header("refresh:2;url=view_tt.php");
}
else 
{
echo "<center><font size=\"4\">Error encountered.Please try again</font>";
