...
<?php
echo "<h1><center>Select any branch to view schedule of a faculty/assign a class to other faculty.</center></h1>";
	...
	if($result)
	{
		if(mysql_num_rows($result)>0)
		{
			...
			while($row=mysql_fetch_array($result))
			{
				...
				echo "<td>"."<a href=\"view_det.php?dept_id=$branch\">Select</a>"."</td>";
				echo "</tr>";
			}
		}
		else
