	 ...
	 var methods = {
		...
		*/
		_isDate: function (value) {
			var val=value.split('-');
			var value1=val[1]+"/"+val[0]+"/"+val[2];
			var dateRegEx = new RegExp(/^\d{4}[\/\-](0?[1-9]|1[012])[\/\-](0?[1-9]|[12][0-9]|3[01])$|^(?:(?:(?:0?[13578]|1[02])(\/|-)31)|(?:(?:0?[1,3-9]|1[0-2])(\/|-)(?:29|30)))(\/|-)(?:[1-9]\d\d\d|\d[1-9]\d\d|\d\d[1-9]\d|\d\d\d[1-9])$|^(?:(?:0?[1-9]|1[0-2])(\/|-)(?:0?[1-9]|1\d|2[0-8]))(\/|-)(?:[1-9]\d\d\d|\d[1-9]\d\d|\d\d[1-9]\d|\d\d\d[1-9])$|^(0?2(\/|-)29)(\/|-)(?:(?:0[48]00|[13579][26]00|[2468][048]00)|(?:\d\d)?(?:0[48]|[2468][048]|[13579][26]))$/);
			return dateRegEx.test(value1);
		},
		/**
		...
		*/
		...
		{
			var dt1  = parseInt(start.substring(0,2),10);
			var mon1 = parseInt(start.substring(3,5),10);
			var yr1  = parseInt(start.substring(6,10),10);
			var dt2  = parseInt(end.substring(0,2),10);
			var mon2 = parseInt(end.substring(3,5),10);
			var yr2  = parseInt(end.substring(6,10),10);
